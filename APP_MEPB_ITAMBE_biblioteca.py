...
class InterfaceMEPB(Validador):
    def __init__(self) -> None:
        ...
        self.janela = self.abrirJanela()

        self.frameJanela = tb.Frame(self.janela, bootstyle='defalt')
        self.logo = self.carregarImagem(self.frameJanela, 'C:/arquivosBiblioteca/logo.jpg')
        self.igreja = self.igreja(self.frameJanela)
    ...
    def principal(self):
        ...
        membros = self.carregarImagem(self.frameFuncao, 'C:/arquivosBiblioteca/membros.png')

        nomeArquivo = 'C:/arquivosBiblioteca/historia.json'
        informacoes = ''
